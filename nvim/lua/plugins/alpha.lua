local config = function()
    ...
    dashboard.section.buttons.val = {
        dashboard.button("f", "󰥨   Find Files", "<cmd>cd $HOME | FzfLua files<CR>"),
        dashboard.button("g", "   Find Words", "<cmd>FzfLua live_grep<CR>"),
        dashboard.button("r", "󰱼   Recent Files", "<cmd>FzfLua oldfiles<CR>"),
